...
# Part A — Speaker A {background-color="#2c3e50"}
...
# Part B — Speaker B {background-color="#2c3e50"}
...
# Part C — Speaker C {background-color="#2c3e50"}
...
- We observe $x_i$ but there is **no associated response** $y_i$
- We're "working blind" — no response variable to supervise the analysis
- Example task: **cluster analysis** — identifying distinct groups among observations (e.g., market segmentation)

<!-- Insert Figure 2.8 here: clustering example with well-separated vs. overlapping groups -->
![](images/fig2_8_clustering.png){fig-alt="Clustering example with well-separated and overlapping groups"}
